...
<Callout emoji="💭">
 ...
 use them so much without thinking, I can forget the base definition! It's a good reminder to go back to the basics, and it's cool too. In a way, maybe exponents scale things up, while logs scale them down (I'm sure there is something suspect in that statement, but it's interesting to think about).
</Callout>
